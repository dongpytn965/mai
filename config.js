const nameGirl = 'La Thanh Mai';
const giftUrl = '';
const eventName = 'Chúc Mừng 20-10';
const titleCard = 'Tặng Mai 20/10';
const contentCard = 'Chúc em 20/10 vui vẻ, Chúc em luôn luôn xinh đẹp, hạnh phúc và thành công trong cuộc sống';
